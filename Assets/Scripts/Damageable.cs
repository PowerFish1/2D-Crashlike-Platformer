...
public class Damageable : MonoBehaviour
{
    ...
    public int Health
    {
        ...
        set
        {
            ...
            // If health drops zero or below, character is no longer alive
    ...
    public bool Hit(int damage, Vector2 knockback)
    {
        if (IsAlive && !isInvincible)
        {
            ...
            // Notify other subscribed components that the damageable was to hit to handle the knockback and such
    ...
    public bool Heal(int healthAmount)
    {
        if (IsAlive && Health < MaxHealth)
        {
            ...
            int actualHeal = Mathf.Min(maxHeal, healthAmount);
            Health += actualHeal;
